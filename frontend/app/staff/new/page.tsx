...
export default function NewStaffPage() {
  ...
  const mutation = useMutation({
    mutationFn: () =>
      api.post<Staff>("/staff/", { name, title, phone, email }),
    onSuccess: () => {
    ...
    <div className="min-h-screen bg-background px-6 py-10">
      <div className="mx-auto max-w-lg">
        <Card className="border-border/60">
          <CardHeader>
            <CardTitle className="font-heading text-2xl italic">New Staff Member</CardTitle>
          </CardHeader>
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Input id="title" placeholder="e.g. Senior Barber" value={title} onChange={(e) => setTitle(e.target.value)} />
              </div>
              <div className="space-y-2">
